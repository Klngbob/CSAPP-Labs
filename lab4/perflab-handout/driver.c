...
//static int test_dim_rotate[] = {32, 64, 128, 256, 512};
static int test_dim_rotate[] = {256, 512, 1024, 2048, 4096};
//static int test_dim_smooth[] = {32, 64, 128, 256, 512};
static int test_dim_smooth[] = {256, 512, 1024, 2048, 4096};
